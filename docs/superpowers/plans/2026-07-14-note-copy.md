...
- [ ] **Step 1: Add failing clipboard writer tests**
...
- [ ] **Step 3: Implement the clipboard writer**
...
- [ ] **Step 3: Add the notes-only toolbar action**
...
- [ ] **Step 4: Wire current local note state to the clipboard writer**
...
- [ ] **Step 4: Commit verification bookkeeping**
...
- [ ] **Step 5: Comment the Linear implementation handoff**
