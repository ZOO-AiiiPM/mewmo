...
export function ConfirmDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 animate-in fade-in duration-150"
      onMouseDown={e => {
        if (e.target === e.currentTarget) onCancel();
      }}
    >
      <div className="min-w-[340px] max-w-[440px] bg-white dark:bg-stone-800 rounded-xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 overflow-hidden">
